    ...
    <div class="max-w-marketing mx-auto px-5 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-wrap gap-4 pt-4">
                <div class="flex items-center gap-2">
                    <x-ui.icon name="verified" class="w-5 h-5 text-primary" />
                    <span class="text-sm font-medium">Fully Licensed</span>
                </div>
                <div class="flex items-center gap-2">
                    <x-ui.icon name="monitoring" class="w-5 h-5 text-primary" />
        ...
        <div class="glassmorphism p-8 rounded-2xl shadow-2xl">
            <h3 class="text-xl font-bold mb-6 flex items-center gap-2">
                <x-ui.icon name="analytics" class="w-5 h-5 text-primary" />
                Exchange Calculator
            </h3>
            <div class="space-y-4">
                <div>
                ...
                <div class="flex justify-center -my-2 relative z-10">
                    <div class="bg-primary p-2 rounded-full shadow-lg shadow-primary/30">
                        <x-ui.icon name="arrow-down" class="w-5 h-5 text-white" />
                    </div>
                </div>
                <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="flex flex-col items-center text-center">
                <div class="size-16 rounded-2xl bg-slate-800 flex items-center justify-center mb-6 border border-slate-700">
                    <x-ui.icon name="wallet" class="w-8 h-8 text-primary" />
                </div>
            ...
            <div class="flex flex-col items-center text-center">
                <div class="size-16 rounded-2xl bg-slate-800 flex items-center justify-center mb-6 border border-slate-700">
                    <x-ui.icon name="lock" class="w-8 h-8 text-primary" />
                </div>
            ...
            <div class="flex flex-col items-center text-center">
                <div class="size-16 rounded-2xl bg-slate-800 flex items-center justify-center mb-6 border border-slate-700">
                    <x-ui.icon name="deposit" class="w-8 h-8 text-primary" />
                </div>
