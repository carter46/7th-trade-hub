    ...
    <div class="grid lg:grid-cols-2 gap-10">
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('checkout.platform.show', $product->slug) }}" class="inline-flex px-6 py-3 rounded-xl bg-white text-slate-900 hover:bg-accent hover:text-white font-bold transition-colors">Buy now</a>
                @auth
