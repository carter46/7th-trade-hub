...
>
    <x-dashboard.card
        ...
        x-data="manualBankPayment({
            ...
            proofSubmitted: @js($proofSubmitted),
    ...
    >
        <div class="space-y-6">
            ...
            <template x-if="proofSubmitted || submitted">
            ...
            <template x-if="!proofSubmitted && !submitted && phase === 'failed'">
                <div class="rounded-xl border-2 border-danger/40 bg-danger/10 px-5 py-6 text-center space-y-3">
            ...
            <template x-if="!proofSubmitted && !submitted && phase === 'active' && !showProofForm">
                <div class="space-y-5">
                    <div class="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-primary/30 bg-primary/5 px-4 py-3">
                        ...
                        <p class="text-2xl font-bold tabular-nums text-primary" x-text="countdownLabel">10:00</p>
                    </div>
                    ...
                    <x-dashboard.button type="button" variant="primary" class="w-full" x-on:click="showProofForm = true">
            ...
            <template x-if="!proofSubmitted && !submitted && phase === 'active' && showProofForm">
                <form class="space-y-4" x-on:submit.prevent="submitProof()">
                    <x-dashboard.alert type="info">
