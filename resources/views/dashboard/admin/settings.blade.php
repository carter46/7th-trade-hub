...
>
    <div class="space-y-6">
        ...
        <x-ui.card variant="solid">
            <h2 class="text-lg font-semibold text-white mb-4">Fees & limits</h2>
            <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-4" x-data="{ submitting: false }" @submit="submitting = true">
                ...
                <h2 class="text-lg font-semibold text-white mb-1">Live chat & contact</h2>
        ...
        <x-ui.card variant="solid">
            <h2 class="text-lg font-semibold text-white mb-1">Email configuration</h2>
            ...
            <form method="POST" action="{{ route('admin.settings.test-mail') }}" class="space-y-4" x-data="{ sending: false }" @submit="sending = true">
                ...
                @enderror
                <x-ui.button type="submit" variant="secondary" x-bind:disabled="sending">Send test email</x-ui.button>
            </form>
        </x-ui.card>
    </div>
</x-layout.page>
