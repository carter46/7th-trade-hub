...
return [
    'user' => [
        ...
        [
            ...
            'icon' => 'listings',
            'keywords' => ['catalog', 'platform', 'buy', 'services', 'browse'],
            'sort' => 20,
        ],
        [
            'type' => 'link',
            ...
            'match' => ['dashboard.my-tools', 'dashboard.my-tools.*', 'dashboard.my-domains', 'dashboard.my-domains.*'],
            'icon' => 'listings',
            'keywords' => ['websites', 'domains', 'tools', 'owned', 'dns'],
            'sort' => 25,
        ],
        [
            'type' => 'link',
            ...
            'icon' => 'orders',
            'keywords' => ['purchases', 'platform', 'service orders', 'receipts'],
            'sort' => 28,
        ],
        [
            'type' => 'group',
