...
| [php/poll-subscription.php](php/poll-subscription.php) | Fallback Hub GET reconciliation helper (not required cron) |
| [php/non-auth-site-gate.php](php/non-auth-site-gate.php) | Non-authenticated site: health + sync + public gate |
