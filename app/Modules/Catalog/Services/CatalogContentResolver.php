...
class CatalogContentResolver
{
    ...
    public function forServiceCategory(ServiceCategory $category): array
    {
        ...
        return [
            ...
            'hero_subtitle' => $category->short_description ?: ($config['hero_subtitle'] ?? null),
    ...
    public function forService(ProductType $service): array
    {
        ...
        return [
            ...
            'hero_subtitle' => $service->short_description ?: ($config['hero_subtitle'] ?? null),
            'card_image' => $cardImage,
            'banner_image' => $bannerImage,
            'benefits' => [],
    ...
    private function fromConfig(array $config, array $extras): array
    {
        ...
        return array_merge([
            ...
            'hero_title' => $label,
            'hero_subtitle' => $config['short_description'] ?? null,
